...
import { resolveOnboardingRevealFocus } from "@/lib/first-run-focus";
...
export function SceneHorizon({
  ...
  const revealFocus = useMemo(

    () => resolveOnboardingRevealFocus(areas, themeId, hubBranchId),

    [areas, themeId, hubBranchId],
  ...
  useEffect(() => {
    ...
    const timer = window.setTimeout(() => {
      ...
      setStreamPanFocus({
        ...
        areaId: revealFocus.areaId,

        branchId: revealFocus.branchId,
  ...
  return (
    ...
    >
      ...
      {/* Live tree — zoomed to the theme/hub where the first pursuit landed */}
      ...
      <OnboardingTreeBackground
        ...
        focusedLimbId={revealFocus?.areaId ?? null}

        initialFitAreaIds={revealFocus ? [revealFocus.areaId] : undefined}

        highlightGoalId={revealFocus?.goalId ?? null}
