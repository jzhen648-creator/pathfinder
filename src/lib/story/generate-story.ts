...
const STORY_PROMPT_BASE = [
  ...
  "- When the user has confirmed a relationship, lead with it and use its label. Otherwise you may relate pursuits through plain world knowledge, but do not imply it is a link the user made. Never invent pursuits, milestones, or facts.",
