...
function buildDeltaSystemPrompt(totalPursuitCount: number): string {
  return [
    ...
    "Ground on the reading packet facts — do not re-derive status counts, category mixes, deadlines, or chronological spine events.",
    "Trust recentEvents.past and recentEvents.upcoming for dated progression; do not invent timeline beats.",
