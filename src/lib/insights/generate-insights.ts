...
const PURSUIT_INSIGHT_SYSTEM_PROMPT = [
  ...
  "- Pursuits may include currentAmount, targetAmount, unit, amountBasis (gross|net), deadline — prefer these structured fields over re-parsing description when benchmarking finance or measurable goals.",
...
const SYSTEM_PROMPT = [
  ...
  "- Pursuits may include description (living context), enrichAnswers (structured quick-question answers), currentAmount, targetAmount, unit, amountBasis (gross|net), deadline — prefer these structured fields over re-parsing title when benchmarking finance or measurable goals.",
  "- If the map is sparse, say so honestly — do not invent pursuits or imply activity that is not in context.",
