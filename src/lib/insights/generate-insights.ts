...
const PURSUIT_INSIGHT_SYSTEM_PROMPT = [
  ...
  "- Only use pursuits, themes, milestones, enrichAnswers, background, and profile fields in context. Never invent facts, pursuits, or progress.",
  "- Pursuits may include currentAmount, targetAmount, unit, amountBasis (gross|net), deadline — prefer these structured fields over re-parsing background when benchmarking finance or measurable goals.",
...
const SYSTEM_PROMPT = [
  ...
  "",
  "GROUND TRUTH:",
  "- Only use pursuits, categories, themes, milestones, enrichAnswers, background, and profile fields in context. Never invent facts, pursuits, or progress.",
  "- Pursuits may include background (user freeform context), enrichAnswers (structured quick-question answers), currentAmount, targetAmount, unit, amountBasis (gross|net), deadline — prefer these structured fields over re-parsing title when benchmarking finance or measurable goals.",
  "- If the map is sparse, say so honestly — do not invent pursuits or imply activity that is not in context.",
