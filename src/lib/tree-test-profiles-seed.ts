...
const branchSeedsFullTreeShowcase: BranchSeed[] = [
  ...
  { limbId: "becoming", threadType: "Purpose", name: "Purpose", goal: null, goalValue: null, currentValue: null, unit: null, status: "active", bloomStatus: "ACTIVE", createdAt: new Date("2019-01-01") },
  { limbId: "becoming", threadType: "Inner life", name: "Inner life", goal: null, goalValue: null, currentValue: null, unit: null, status: "active", bloomStatus: "ACTIVE", createdAt: new Date("2020-02-01") },
  { limbId: "becoming", threadType: "Joy", name: "Joy", goal: null, goalValue: null, currentValue: null, unit: null, status: "active", bloomStatus: "ACTIVE", createdAt: new Date("2022-06-01") },
...
const markSeedsFullTreeShowcase: MarkSeed[] = [
  ...
  { branchThreadType: "Purpose", limbId: "becoming", title: "North star written", description: "Becoming thread 0.", date: new Date("2019-03-01"), year: 2019, significance: 2, sentiment: "positive", value: null, isTurningPoint: false, future: false },
  { branchThreadType: "Purpose", limbId: "becoming", title: "Vision refined", description: "Becoming thread 0 continued.", date: new Date("2024-01-01"), year: 2024, significance: 2, sentiment: "positive", value: null, isTurningPoint: false, future: true },
  { branchThreadType: "Purpose", limbId: "becoming", title: "Mentor season", description: "Becoming purpose thread.", date: new Date("2019-08-01"), year: 2019, significance: 1, sentiment: "positive", value: null, isTurningPoint: false, future: false },
  { branchThreadType: "Purpose", limbId: "becoming", title: "Course sprint", description: "Becoming purpose continued.", date: new Date("2023-05-01"), year: 2023, significance: 2, sentiment: "positive", value: null, isTurningPoint: false, future: false },
  { branchThreadType: "Inner life", limbId: "becoming", title: "Values clarified", description: "Becoming mind thread.", date: new Date("2020-04-01"), year: 2020, significance: 2, sentiment: "positive", value: null, isTurningPoint: false, future: false },
  { branchThreadType: "Inner life", limbId: "becoming", title: "Identity in practice", description: "Becoming mind continued.", date: new Date("2024-08-01"), year: 2024, significance: 2, sentiment: "positive", value: null, isTurningPoint: false, future: true },
  { branchThreadType: "Inner life", limbId: "becoming", title: "Morning block", description: "Becoming mind thread.", date: new Date("2021-01-01"), year: 2021, significance: 1, sentiment: "positive", value: null, isTurningPoint: false, future: false },
  { branchThreadType: "Inner life", limbId: "becoming", title: "Review ritual", description: "Becoming mind continued.", date: new Date("2024-03-01"), year: 2024, significance: 2, sentiment: "positive", value: null, isTurningPoint: false, future: true },
  { branchThreadType: "Joy", limbId: "becoming", title: "Returned to weekend sketching", description: "Becoming joy thread.", date: new Date("2021-08-01"), year: 2021, significance: 1, sentiment: "positive", value: null, isTurningPoint: false, future: false },
  { branchThreadType: "Joy", limbId: "becoming", title: "First solo trip abroad", description: "Becoming joy continued.", date: new Date("2023-05-01"), year: 2023, significance: 2, sentiment: "positive", value: null, isTurningPoint: false, future: false },
