...
export const STREAM_EXTRACT_THEME_SYSTEM_PROMPT = [
  ...
  "",
  "- Every mark, pursuit, and milestone MUST include hubId — the normalized category slug from context (e.g. \"career & role\", \"skills & learning\", \"projects & shipping\" for Work & Career; \"employment income\", \"rental & property income\" for Money & Finance).",
...
export const STREAM_EXTRACT_GLOBAL_SYSTEM_PROMPT = [
  ...
  '  "pursuits": [{ "title": "string", "description": "1-2 sentence summary or null", "goalType": "project|identity", "bloomStatus": "ACTIVE|MAINTAINING|ON_HOLD|COMPLETE", "hubId": "hub branch id", "deadline": "YYYY-MM-DD or null", "clientKey": "optional", "sourcePhrase": "optional", "titleConfidence": "optional", "suggestedTitle": "optional/null", "reviewNote": "optional/null", "eventContext": "optional/null" }],',
  '  "milestones": [],',
  '  "pursuitUpdates": [{ "goalId": "existing goal id", "title": "optional new title", "bloomStatus": "optional ACTIVE|MAINTAINING|ON_HOLD|COMPLETE" }],',
