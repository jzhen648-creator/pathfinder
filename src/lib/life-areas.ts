...
export const LIFE_AREAS: LifeArea[] = [
  {
    ...
    addPrompt: "Add a money & finance goal",
  ...
  },
  {
    ...
    addPrompt: "Add a people & relationships goal",
  ...
  },
  {
    ...
    addPrompt: "Add a health & body goal",
    examples: ["Started training", "Built a habit", "Health turning point"],
  },
  {
    id: "pleasures",
    label: "Pleasures",
    sublabel: "Your enjoyment of life",
    color: "#38BDF8",
    angle: 102,
    emptyPrompt: "What restores you and brings you alive?",
    firstMarkQuestion: "What was the first joy or hobby that felt unmistakably yours?",
    addPrompt: "Add a pleasures goal",
    examples: ["Deepened a hobby", "A trip that stuck", "Protected downtime"],
  },
];
